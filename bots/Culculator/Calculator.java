...
public class Calculator {
    ...
    private boolean defend(Iceberg underAttack, Game game, Map<Iceberg, Integer> freePeng, UnderAttackAlert alert) {
        ...
        while (freePeng.get(underAttack) < 0) {
            ...
            int diifToWin = -allreadyOnWay - underAttack.penguinAmount
                    - underAttack.penguinsPerTurn * farest.turnsTillArrival + sumOfAttackers;
            ...
            if (sumOfAttackers - sumOfLateAttackers < underAttack.penguinAmount
                    + underAttack.penguinsPerTurn * closest.getTurnsTillArrival(underAttack)) {
                // will survive
            ...
            // fight till die!!!!
            // now send the minimum between freePeng and how need to defend in the closest
            // to
